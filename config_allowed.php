<?php
  ...
  $allowed_rooms = array(
    ...
    'Nordmetall'  => array_unique(
      ...
      // )
      array(
        'A-301','A-303','A-305','A-307','A-309','A-311','A-313','A-315','A-317','A-319','A-321','A-323','A-325','A-327','A-329','A-331','A-333','A-335','A-523','A-525','A-527','A-529','A-531','A-533','A-535','C-203','C-208','C-216','C-222','C-224','C-303','C-308','C-316','C-408','C-416'
      )
      // array_merge(
